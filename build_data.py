...
tf.flags.DEFINE_string('X_input_dir', r'/media/cugxyy/han/image_defog_new/trainY_rotate',
                       'X input directory, default: data/apple2orange/trainA')
tf.flags.DEFINE_string('Y_input_dir', r'/media/cugxyy/han/image_defog_new/trainY_smooth_rotate',
                       'Y input directory, default: data/apple2orange/trainA')


tf.flags.DEFINE_string('X_output_file', r'9444/unfog.tfrecords',
                       'X output tfrecords file, default: data/tfrecords/apple.tfrecords')
tf.flags.DEFINE_string('Y_output_file', r'9444/unfog_smooth.tfrecords',
